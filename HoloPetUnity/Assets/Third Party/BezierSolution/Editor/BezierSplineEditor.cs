...
public class BezierSplineEditor : Editor
{
	...
	private void DrawBezierPointAt( int index )
	{
		...
		DrawBezierPointAt( index, EndPointIndex.CONTROL_POINT_NONE, Handles.DotHandleCap );
		...
		DrawBezierPointAt( index, EndPointIndex.CONTROL_POINT_PRECEDING, Handles.RectangleHandleCap);
		DrawBezierPointAt( index, EndPointIndex.CONTROL_POINT_FOLLOWING, Handles.RectangleHandleCap );
