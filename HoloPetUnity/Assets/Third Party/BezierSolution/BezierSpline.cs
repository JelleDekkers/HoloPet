...
public class BezierSpline : MonoBehaviour
{
    ...
    public BezierPoint InsertNewPointAtWorldPosition(int index, Vector3 worldPosition) {
        return InsertNewPointAt(index, new BezierPoint(this, transform.InverseTransformPoint(worldPosition)));
    }
